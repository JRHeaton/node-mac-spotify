...
@class SPApplication, SPTrack, SPApplication;
...
@interface SPApplication : SBApplication

@property (copy, readonly) SPTrack *currentTrack;  // The current playing track.
@property NSInteger soundVolume;  // The sound output volume (0 = minimum, 100 = maximum)
@property (readonly) SPEPlS playerState;  // Is Spotify stopped, paused, or playing?
...
@interface SPApplication (StandardSuite)
